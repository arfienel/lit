...
urlpatterns = [
    ...
    path('books/read_chapter/<int:pk>', read_chapter, name='chapter_read'),
    path('books/<int:pk>/add_chapter', add_chapter, name='chapter_add'),
    path('books/<int:pk>/edit_book', edit_book, name='book_edit'),
    path('books/<int:pk>/edit_chapter', edit_chapter, name='chapter_edit'),
